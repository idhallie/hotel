...
describe "Hotel" do
  describe "#initialize" do
    ...
    it "keeps track of reservation instances" do
      reservation_1 = Reservation.new(34, @new_room, start_date: Date.new(2019-10-3), end_date: Date.new(2019-10-6), hotel: @new_hotel)
      reservation_2 = Reservation.new(34, @new_room, start_date: Date.new(2019-10-7), end_date: Date.new(2019-10-12), hotel: @new_hotel)
